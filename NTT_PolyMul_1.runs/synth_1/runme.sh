...
HD_PWD='C:/Users/swarn/Desktop/Verilog_Vivado/NTT_PolyMul_1/NTT_PolyMul_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ntt_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ntt_core.tcl
